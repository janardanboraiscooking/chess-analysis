            ...
            <Reveal delay={240}>
              <div className="flex flex-wrap gap-3">
                <Link href="/analyse" className="btn-primary btn-lg">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M14 14L11 11M7 12A5 5 0 107 2a5 5 0 000 10z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>
                  Analyze a Game
                </Link>
                <Link href="/features" className="btn-secondary btn-lg">Explore Features</Link>
