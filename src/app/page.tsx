          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 stagger">
            <div className="card p-6">
              ...
              <ul className="space-y-2 text-sm text-[var(--cream-dim)]">
                {['PGN is parsed into individual positions', 'Stockfish cloud API (depth 15) with local fallback', '5 parallel workers for fast analysis', 'Moves classified by win% delta (Lichess algorithm)'].map((t, i) => (
