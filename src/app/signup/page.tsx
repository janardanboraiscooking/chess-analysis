    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-14">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Join the GoatedChess community</p>
        </div>
        ...
        <div className="surface p-6">
          <div className="space-y-4">
            ...
            <button className="btn-primary w-full py-2.5">Create account</button>
          </div>

          <div className="relative my-5">
            <div className="section-divider" />
            <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-3 text-xs" style={{ color: 'var(--text-muted)', background: 'var(--bg-card)' }}>or</span>
          </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
          Already have an account? <Link href="/signin" className="text-[var(--gold)] hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
