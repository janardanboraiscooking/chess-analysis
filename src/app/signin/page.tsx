    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-14">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Sign in to your GoatedChess account</p>
        </div>
        ...
        <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
          Don&apos;t have an account? <Link href="/signup" className="text-[var(--gold)] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
